...
def print_example(word2id, context_tokens, qn_tokens, true_ans_start, true_ans_end, pred_ans_start, pred_ans_end, true_answer, pred_answer, f1, em):
    ...
    assert pred_ans_start in range(curr_context_len), '%d => %d | %d'%(pred_ans_start, pred_ans_end, curr_context_len)
    assert pred_ans_end in range(curr_context_len), '%d => %d | %d'%(pred_ans_start, pred_ans_end, curr_context_len)
